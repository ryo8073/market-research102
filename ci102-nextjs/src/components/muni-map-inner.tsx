          ...
          <div className="text-xs space-y-0.5">
            ...
            {hover.type === "flood" && (
              <>
                ...
                <p className="text-xs text-slate-500 mt-1">想定最大規模降雨での計算値</p>
              </>
            )}
            {hover.type === "did" && (
              <>
                ...
                <p className="text-xs text-slate-500 mt-1">人口密度 4,000人/km²以上の連続区域</p>
              </>
            )}
            {hover.type === "zoning" && (
              <>
            ...
            {hover.type === "location_opt" && (
              <>
                ...
                <p className="text-xs text-slate-500 mt-1">居住誘導区域 or 都市機能誘導区域</p>
              </>
            )}
            {hover.type === "muni" && (
              <>
