                  ...
                  <tbody>
                    ...
                    <tr className="border-b">
                      <td className="py-1.5 px-2">
                        HHI（産業集中度）<br/>
                        <span className="text-xs font-mono text-slate-500">Σ(シェア×100)²</span>
                      </td>
                    ...
                    <tr className="border-b">
                      <td className="py-1.5 px-2">
                        有効業種数<br/>
                        <span className="text-xs font-mono text-slate-500">1 / Σ シェア²</span>
                      </td>
                    ...
                    <tr className="border-b">
                      <td className="py-1.5 px-2">
                        シャノンエントロピー H<br/>
                        <span className="text-xs font-mono text-slate-500">-Σ シェア×ln(シェア)</span>
                      </td>
                    ...
                    <tr className="border-b">
                      <td className="py-1.5 px-2">
                        ...
                        <span className="text-xs font-mono text-slate-500">上位5業種の合計</span>
                      </td>
